					...
					<div class="inner-wrap">
						...
						<header id="masthead" role="banner">
							...
							<nav id="account" class="account-navigation" role="navigation">
								...
								<?php } else { ?>
									<li>
										<a class="icon-login hello" href="<?php echo Route::url('index.php?option=com_users&view=login'); ?>" title="<?php echo Lang::txt('TPL_MATIN_LOGIN'); ?>"><?php echo Lang::txt('Login'); ?></a>
									</li>
